...
-- Password Hash: $2b$10$MnaFvYNKnwbjFCJlyV.Mbe4WPrFby4zW/dSi/fxpyXd84rz6O4ySa
INSERT INTO users (full_name, email, password, phone, role, active, customer_id, created_at, updated_at) VALUES
('System Manager', 'manager@keystone.com', '$2b$10$MnaFvYNKnwbjFCJlyV.Mbe4WPrFby4zW/dSi/fxpyXd84rz6O4ySa', '1234567890', 'MANAGER', true, null, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('Central Dispatcher', 'dispatcher@keystone.com', '$2b$10$MnaFvYNKnwbjFCJlyV.Mbe4WPrFby4zW/dSi/fxpyXd84rz6O4ySa', '1234567891', 'DISPATCHER', true, null, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('John Doe Tech', 'technician@keystone.com', '$2b$10$MnaFvYNKnwbjFCJlyV.Mbe4WPrFby4zW/dSi/fxpyXd84rz6O4ySa', '1234567892', 'TECHNICIAN', true, null, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('Jane Smith Customer', 'customer@keystone.com', '$2b$10$MnaFvYNKnwbjFCJlyV.Mbe4WPrFby4zW/dSi/fxpyXd84rz6O4ySa', '1234567893', 'CUSTOMER', true, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('Bob Builder Tech', 'bob@keystone.com', '$2b$10$MnaFvYNKnwbjFCJlyV.Mbe4WPrFby4zW/dSi/fxpyXd84rz6O4ySa', '1234567894', 'TECHNICIAN', true, null, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
